...
export const HeroReview = () => {
  return (
    <div
      className="w-full md:w-[400px] xl:w-[409px] blur-style h-auto min-h-[180px] xl:h-[237px] rounded-[24px] sm:rounded-[35px] xl:rounded-[45px] p-5 sm:p-7 pr-6 sm:pr-10 flex justify-center flex-col gap-3 sm:gap-4"
      style={{
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col gap-1">
          <span className="text-white font-normal text-base sm:text-lg xl:text-[22px]">Ronnie Hamill</span>
